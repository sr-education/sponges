    ...
    def initialize(supervisor)
      ...
      at_exit do
        for_supervisor do
          ...
          `sudo /usr/bin/knife node delete #{full_hostname} -y -u #{full_hostname} -s https://nyx.reachnetwork.com:443 -k /etc/chef/client.pem -c /etc/chef/client.rb`
          `sudo /usr/bin/knife client delete #{full_hostname} -y -u #{full_hostname} -s https://nyx.reachnetwork.com:443 -k /etc/chef/client.pem -c /etc/chef/client.rb`
